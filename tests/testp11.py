    ...
    def run(self):
        ...
        hyper_graph1b = HyperGraph(
            ...
            edges=[
                ...
                ({'v9', 'v6'}, {'label': 'E', 'B': False}),
                ({'v1', 'v2', 'v5', 'v3', 'v4', 'v6'}, {'label': 'S', 'R': True})
            ]
        )

        hyper_graph1b.visualize()

        for production in productions:
            for hyper_node in hyper_graph1b.hyper_nodes:
                if production.check(hyper_graph1b, hyper_node):
                    hyper_graph1b.visualize()
                    hyper_graph1b = production.apply(hyper_graph1b, hyper_node)
                    hyper_graph1b.visualize()
                    break
